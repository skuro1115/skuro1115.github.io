...
3つの順番をすべて当てたら100点。「え、そっちが1位なの！？」という驚きと会話が自然に生まれる、友達の意外な一面が見えるゲームです。`,
    ...
    badge: 'live',
    badgeLabel: 'App Store',
    appStoreUrl: 'https://apps.apple.com/jp/app/guessrank/id6763001964',
    iconUrl: 'https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/6e/2a/da/6e2adadd-d813-d53d-d4ff-c4c8cde488ab/AppIcon-0-0-1x_U007epad-0-1-85-220.png/512x512bb.jpg',
    ...
    showInApps: true,
    hasLanding: true,
    relatedPostSlugs: ['guess-rank-pivot'],
  },
  {
    id: 'honnemawolf',
    title: 'ホンネ人狼',
